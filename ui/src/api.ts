...
const API = import.meta.env.VITE_API_URL || (isProduction ? "/proxy/api" : "http://localhost:3001");
const AGENT_API = import.meta.env.VITE_AGENT_URL || (isProduction ? "/proxy/agent" : "http://localhost:3002");
